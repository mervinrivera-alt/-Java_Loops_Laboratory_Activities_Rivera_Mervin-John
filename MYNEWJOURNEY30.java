...
public class MYNEWJOURNEY30 {
    ...
    switch(A) {
        case 1:
          ...
          if(F<0 || F<=10){int G=1;
            int H=(F*G);
            while (G <= 10) {System.out.println(F+"*"+G+"="+H); G++; H=(F*G); a=false;} break;}
          else { System.out.println("Invalid Data \n Want to try Again?\n 1.for Yes\n 2.for No");
                  System.out.print("Enter Here: ");
                  int b=input.nextInt();
                  if(b==1){};
                  if(b==2){System.out.println("Program down"); a=false;} break;
          }
        ...
        case 3:
            ...
            System.out.print("Enter Here: ");
                  int c=input.nextInt();
                  if(c==1){};
                  if(c==2){System.out.println("Program down"); a=false;}break;
            
        case 4: 
            System.out.print("Welcome to Activity 4 \n pls Enter a number here: ");
            int K= input.nextInt();
            if (K % 2==0) {System.out.print("Even Numers: ");
                           int L=2;
                           while (L<=K){System.out.print(L+" "); L+=2;}}
            else { System.out.print("Odd Numbers: ");
                  int M=1;
                  while (M<=K){System.out.print(M+" "); M+=2; }}
            System.out.println("Want to continue?\n 1.for Yes\n 2.for No  ");
            System.out.print("Enter Here: ");
                  int d=input.nextInt();
                  if(d==1){};
                  if(d==2){System.out.println("Program down"); a=false;}break;
        case 5:
            System.out.println("Welcome to Activity 5 \n pls Enter the number to be reverse");
            int N=input.nextInt();
            int O=0;
            while (N>0){int P=N%10;
            O=O*10+P; N=N/10;}
            ...
            System.out.print("Enter Here: ");
                  int e=input.nextInt();
                  if(e==1){};
                  if(e==2){System.out.println("Program down"); a=false;}}}}}
